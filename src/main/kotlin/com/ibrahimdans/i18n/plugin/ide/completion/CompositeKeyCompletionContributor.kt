    ...
    private fun groupPlurals(completions: List<String>, pluralSeparator: String): List<String> {
        ...
        return completions
            ...
            .entries.flatMap { entry ->
                ...
                val isCldrPlural = entry.value.isNotEmpty() && entry.value.all { v -> cldrSuffixes.any { v.endsWith(it) } }
                if (isNumericPlural || isCldrPlural) listOf(entry.key) else entry.value
            }
    }
