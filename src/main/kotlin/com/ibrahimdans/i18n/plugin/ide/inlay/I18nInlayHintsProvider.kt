 ...
 * getCollectorFor once per matching language registration for the same file, which would
...
class I18nInlayHintsProvider : InlayHintsProvider<NoSettings>, CompositeKeyResolver<PsiElement> {

    companion object {
        private val HINTS_CACHE_KEY = Key.create<Pair<Long, MutableSet<Int>>>("i18n.inlay.offsets")
    }

    override val key = SettingsKey<NoSettings>("i18n.translations.inlay")
    override val name = "i18n translations"
    override val previewText = "t('greeting')"
    ...
    override fun getCollectorFor(
        ...
        override fun collect(element: PsiElement, editor: Editor, sink: InlayHintsSink): Boolean {
            ...
            val rawKey = lang.extractRawKey(element) ?: return true
            val fullKey = RawKeyParser(project).parse(rawKey) ?: return true
            ...
            // IntelliJ invokes getCollectorFor once per registered language (JS/JSX/TS/TSX),
            ...
            val presentation = factory.roundWithBackground(factory.smallText("↦ $translation"))
